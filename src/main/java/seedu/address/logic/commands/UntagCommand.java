...
public class UntagCommand extends Command {
    ...
    public CommandResult removePersonTags(Model model) throws CommandException {
        ...
        ModuleTagSet oldModules = personToEdit.getModuleTagSet();

        oldModules.removeAll(moduleTags);
     ...
     * @return feedback message of the operation result for display.
     */
    public CommandResult removeUserTags(Model model) {
        User editedUser = model.getUser();

        ModuleTagSet userModuleTags = editedUser.getModuleTagSet();

        userModuleTags.removeAll(moduleTags);
